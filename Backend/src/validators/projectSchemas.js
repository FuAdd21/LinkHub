...
export const createProjectSchema = z.object({
  ...
  url: z.string().url("Must be a valid project URL").max(512).optional().nullable().or(z.literal("")),
  image_url: z.string().url("Must be a valid image URL").max(512).optional().nullable().or(z.literal("")),
...
export const createCredentialSchema = z.object({
  ...
  url: z.string().url("Must be a valid credential URL").max(512).optional().nullable().or(z.literal("")),
});
